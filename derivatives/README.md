...
> Derivatives folder are availabel at Figshare repository [10.6084/m9.figshare.30753239](https://doi.org/10.6084/m9.figshare.30753239).
...
Additional derivative files produced during the peer-review revision process. These include reliability analyses, voxel-count summaries, and new model-feature extractions used to address reviewer questions and extend the main analyses.

| File Path                                                                                                                                                                                   | Description                                                                           |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| [roi_dims.parquet](revision/roi_dims.parquet)                                                                                                                                               | Number of voxels per participant and HCP-MMP1 ROI.                                    |
| [rsa_reliability_isrsa-stepwise.42-all-subjects.parquet](revision/rsa_reliability_isrsa-stepwise.42-all-subjects.parquet)                                                                   | Stepwise IS-RSA reliability across ROI as a function of subset size (Reviewer #1 Q4). |
| [rsa_reliability_isrsa.42-all-subjects.parquet](revision/rsa_reliability_isrsa.42-all-subjects.parquet)                                                                                     | IS-RSA reliability using half-split partitions (Reviewer #1 Q4).                      |
| [rsa_reliability_isrsa_repetition_based-42.parquet](revision/rsa_reliability_isrsa_repetition_based-42.parquet)                                                                             | Reliability accounting for trial-level variability per ROI (seed = 42).               |
| [rsa_reliability_isrsa_repetition_based-50.parquet](revision/rsa_reliability_isrsa_repetition_based-50.parquet)                                                                             | Reliability accounting for trial-level variability per ROI (seed = 50).               |
| [sentence-transformers-all-mpnet-base-v2-avg_prompt-coco_subject-model-nsd-mpnet.parquet](revision/sentence-transformers-all-mpnet-base-v2-avg_prompt-coco_subject-model-nsd-mpnet.parquet) | Final-layer MPNet activations for NSD images, extracted following Doerig et al. 2025. |
| [sentence-transformers-mpnet-internal-layers-coco-avg_subject-model-nsd-mpnet.parquet](revision/sentence-transformers-mpnet-internal-layers-coco-avg_subject-model-nsd-mpnet.parquet)       | All transformer-block MPNet activations for NSD images (Doerig et al. 2025).          |

---

## `derivatives/revision/connectivity-surface-mosaic`

Replication of the main IS-RSA connectivity analyses using MOSAIC-fMRI data, processed with a shared surface-based preprocessing pipeline. Each file contains ROI-wise connectivity matrices derived from first-order RSA (correlation or cosine) followed by second-order correlation.

| File Path                                                                                                                                                                                                                                                     | Description                                                                          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [roi_rsa_connectivity_BOLD5000_mmp-joined_correlation-correlation_noshift_symmetric.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_BOLD5000_mmp-joined_correlation-correlation_noshift_symmetric.parquet)                                 | BOLD5000 IS-RSA connectivity (correlation–correlation, full matrix).                 |
| [roi_rsa_connectivity_BOLD5000_mmp-joined_correlation-correlation_noshift_symmetric_diagonal.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_BOLD5000_mmp-joined_correlation-correlation_noshift_symmetric_diagonal.parquet)               | BOLD5000 IS-RSA (correlation–correlation), ROI-wise diagonal (same-ROI comparisons). |
| [roi_rsa_connectivity_BOLD5000_mmp-joined_cosine-correlation_noshift_symmetric.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_BOLD5000_mmp-joined_cosine-correlation_noshift_symmetric.parquet)                                           | BOLD5000 IS-RSA (cosine–correlation), full matrix.                                   |
| [roi_rsa_connectivity_BOLD5000_mmp-joined_cosine-correlation_noshift_symmetric_diagonal.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_BOLD5000_mmp-joined_cosine-correlation_noshift_symmetric_diagonal.parquet)                         | BOLD5000 IS-RSA (cosine–correlation), diagonal.                                      |
| [roi_rsa_connectivity_NSD_mmp-joined_correlation-correlation_shift1_asymmetric.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_NSD_mmp-joined_correlation-correlation_shift1_asymmetric.parquet)                                           | NSD IS-RSA (correlation–correlation, shift = 1).                                     |
| [roi_rsa_connectivity_NSD_mmp-joined_correlation-correlation_shift1_asymmetric_main_connectivity.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_NSD_mmp-joined_correlation-correlation_shift1_asymmetric_main_connectivity.parquet)       | NSD IS-RSA (correlation–correlation), main connectivity matrix.                      |
| [roi_rsa_connectivity_NSD_mmp-joined_cosine-correlation_shift1_asymmetric.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_NSD_mmp-joined_cosine-correlation_shift1_asymmetric.parquet)                                                     | NSD IS-RSA (cosine–correlation, shift = 1).                                          |
| [roi_rsa_connectivity_NSD_mmp-joined_cosine-correlation_shift1_asymmetric_main_connectivity.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_NSD_mmp-joined_cosine-correlation_shift1_asymmetric_main_connectivity.parquet)                 | NSD IS-RSA (cosine–correlation), main connectivity matrix.                           |
| [roi_rsa_connectivity_THINGS_mmp-joined_correlation-correlation_noshift_symmetric_diagonal.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_THINGS_mmp-joined_correlation-correlation_noshift_symmetric_diagonal.parquet)                   | THINGS IS-RSA (correlation–correlation), diagonal.                                   |
| [roi_rsa_connectivity_THINGS_mmp-joined_correlation-correlation_noshift_symmetric_main_connectivity.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_THINGS_mmp-joined_correlation-correlation_noshift_symmetric_main_connectivity.parquet) | THINGS IS-RSA (correlation–correlation), full connectivity matrix.                   |
| [roi_rsa_connectivity_THINGS_mmp-joined_cosine-correlation_noshift_symmetric_diagonal.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_THINGS_mmp-joined_cosine-correlation_noshift_symmetric_diagonal.parquet)                             | THINGS IS-RSA (cosine–correlation), diagonal.                                        |
| [roi_rsa_connectivity_THINGS_mmp-joined_cosine-correlation_noshift_symmetric_main_connectivity.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_THINGS_mmp-joined_cosine-correlation_noshift_symmetric_main_connectivity.parquet)           | THINGS IS-RSA (cosine–correlation), main connectivity matrix.                        |
| [roi_rsa_connectivity_THINGS_mmp_correlation-correlation_noshift_symmetric_diagonal.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_THINGS_mmp_correlation-correlation_noshift_symmetric_diagonal.parquet)                                 | THINGS IS-RSA (correlation–correlation) diagonal (alternative naming variant).       |
| [roi_rsa_connectivity_THINGS_mmp_cosine-correlation_noshift_symmetric_diagonal.parquet](revision/connectivity-surface-mosaic/roi_rsa_connectivity_THINGS_mmp_cosine-correlation_noshift_symmetric_diagonal.parquet)                                           | THINGS IS-RSA (cosine–correlation) diagonal (alternative naming variant).            |
